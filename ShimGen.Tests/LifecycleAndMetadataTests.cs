...
""")]
    public void Preload_Resources_Are_Loaded_Before_Ready()
    {
        ...
        StringAssert.Contains("if (__p_Scene == null)", src);
        StringAssert.Contains("new System.InvalidOperationException(\"[shimgen][Preloader] Missing preload resource", src);
        StringAssert.Contains("for property \\\"Scene\\\" on Game.PreloaderImpl\")", src);
        ...
        StringAssert.Contains("if (__p_Optional == null)", src);
        StringAssert.Contains("new System.InvalidOperationException(\"[shimgen][Preloader] Missing preload resource", src);
        StringAssert.Contains("for property \\\"Optional\\\" on Game.PreloaderImpl\")", src);
