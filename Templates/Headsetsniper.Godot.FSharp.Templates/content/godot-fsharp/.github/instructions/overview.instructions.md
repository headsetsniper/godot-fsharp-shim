...
- Pass `--IncludeTests true` to `dotnet new godot-fsharp` when you want gdUnit4 specs and the TestShims harness, and set `--GodotBinPath <path-to-godot>` so `.runsettings` points at your installed editor.
